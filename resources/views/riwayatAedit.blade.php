    ...
    <form id="edit-form">
        <div class="profile">
            <div class="profile-item">
                ...
                <input type="text" class="edit-input" id="edit-category" value="Botol">
            </div>
            <div class="profile-item">
                <div class="label">Nama Obat:</div>
                <input type="text" class="edit-input" id="edit-name" value="Cendo Catarlent">
            </div>
            <div class="profile-item">
                <div class="label">Stok Obat:</div>
                <input type="text" class="edit-input" id="edit-stock" value="10">
            </div>
            <div class="add">
